...
{
    /// <summary>
    ///  Holds a set of cores and spreads the distribution according to the range of the cores
    /// </summary>
    public class FixedConfinedCoreManager : GenericCoreManager
    {
        ...
        public override void AddCore(GenericCore core)
        {
            Cores.Add((GaussianConfinedCore)core);
        }
